					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<?php 
								if(is_array($catkey)):
									foreach($catkey as $val):
									 ?>
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#sportswear" class="cat" for=
										"<?php echo $val['ca_id']; ?>">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<?php 
									if(is_array($brkey)):
										foreach($brkey as $val):
									 ?>
									<li><a href="#" class="br" for="<?php echo $val['br_id']; ?>"> <span class="pull-right">(50)</span><?php echo $val['br_name']; ?></a></li>
									<?php 
								endforeach;
								endif;
									 ?>
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo $val['p_amount']; ?></h2>
												<p><?php echo $val['p_desc']; ?></p>
												<a href="#" for="<?php echo $val['p_id']; ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
								</div>
								<div class="choose">
